...
<section class="pt-20px pb-20px top-space-margin page-title-big-typography cover-background round-cursor" style="background-image: url({{ asset('frontend-assets/images/banner-image.webp') }}); margin-top: 141px;">
    <div class="container">
            ...
            <div class="col-12 col-lg-8">
                <div class="card shadow-lg border-0">
                    <div class="card-body text-start p-40px">
                        <form action="{{ route('razorpay.payment.store') }}" class="row g-3" id="paymentForm" method="POST">
                            @csrf
                            @if ($errors->any())
            ...
            <div class="col-12 col-lg-4">
                <div class="card shadow-lg border-0">
                    <div class="card-body p-30px">
                        ...
                        <div class="border-bottom pb-5px pt-5px">
                            <label class="fw-normal text-start">GST:</label><span class="float-end fw-bold">
                                18%</span>
                        </div>
                        <div class="pt-5px">
                    ...
                    <button type="button" id="payButton" class="btn btn-extra-small btn-base-color btn-rounded btn-box-shadow btn-switch-text d-inline-block align-middle fw-600 appear anime-complete" data-anime='{ "translateY": [100, 0], "easing": "easeOutCubic", "duration": 900, "delay": 500 }'>
                        <span>
