...
@section('admin_content')
    <div class="container-fluid">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Edit Courses</h5>
                    <div class="card">
                        <div class="card-body p-4">
                            <form action="{{ url('admin/courses/update/' . $service->id) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name"
                                        value="{{ $service->description }}" name="description" required>
                                </div>
