...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('frontend-assets/vdc_images/vdc-favicon.png') }}" />
    <link rel="apple-touch-icon" href="{{ asset('frontend-assets/vdc_images/vdc-favicon.png') }}" />
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('frontend-assets/vdc_images/vdc-favicon.png') }}" />
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('frontend-assets/vdc_images/vdc-favicon.png') }}" />
...
<body data-mobile-nav-style="full-screen-menu" data-mobile-nav-bg-color class="bg-very-light-gray">
    <header class="header-with-topbar">
        ...
        <nav class="navbar navbar-expand-lg bg-dark-blue -header-transparent -bg-transparent header-reverse border-top border-color-extra-medium-gray"
