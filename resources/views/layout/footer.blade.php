<footer class="footer-dark bg-dark-blue pb-0 cover-background background-position-left-top"
    style="background-image: url({{ asset('frontend-assets/images/demo-hosting-footer-bg.jpg') }})">
    <div class="container">
        <div class="row justify-content-center mb-5 md-mb-8 sm-mb-40px">
            ...
            <div class="col-6 col-lg-4 col-sm-4 xs-mb-30px order-sm-5 order-lg-4">
                ...
                <a href="mailto:info@vijayadiagnosticcentre.com"
                    ...
                    <span>jbinternationalproacademy@gmail.com</span></a>
                <span class="d-inline-flex w-100">Contact us</span>
                <a href="tel:+918714060777" class="text-white lh-22 d-inline-flex">+91 8714060777</a>
            </div>
        </div>
